...
void I2CSetup(unsigned long ulI2CBase, unsigned long ulI2CSpeed)
{
    ...
    switch (ulI2CBase)
    {
		...
		case  I2C1_BASE:
			...
			//
			 I2CMasterInitExpClk(I2C1_BASE, SysCtlClockGet(), ulI2CSpeed);
			break;
		...
		case  I2C2_BASE:
			...
			//
			 I2CMasterInitExpClk(I2C2_BASE, SysCtlClockGet(), ulI2CSpeed);
			break;
		...
		case  I2C3_BASE:
			...
			//
			 I2CMasterInitExpClk(I2C3_BASE, SysCtlClockGet(), ulI2CSpeed);
			break;
